...
interface PrivacyAndPoliciesProps {
  isOpen: boolean;
  onClose: () => void;
...
/**
 * Modal para mostrar políticas y privacidad desde PDF
 */
export const PrivacyAndPolicies = ({ isOpen, onClose, onAcceptRead }: PrivacyAndPoliciesProps) => {
