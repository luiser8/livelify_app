...
import { BottomNav, PageHeader, ConfirmModal, Copyright, Pagination, AlertBanner, TermsAndConditions } from '@/shared/components';
...
export const ProfilePage = () => {
  ...
  // Estados para modales de términos y políticas
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col pb-20">
      ...
      <main className="flex-1 p-4 sm:p-6 max-w-7xl mx-auto w-full">
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-6 shadow-sm">
            <div className="mb-4">
              <h3 className="text-base sm:text-lg font-bold text-gray-900">{t('profile.legalDocuments.title')}</h3>
              <p className="text-xs sm:text-sm text-gray-500">{t('profile.legalDocuments.description')}</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="text-sm sm:text-base font-semibold text-gray-900">{t('profile.legalDocuments.terms')}</p>
                    <p className="text-xs text-gray-500">{t('profile.legalDocuments.termsDescription')}</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="text-sm sm:text-base font-semibold text-gray-900">{t('profile.legalDocuments.privacy')}</p>
                    <p className="text-xs text-gray-500">{t('profile.legalDocuments.privacyDescription')}</p>
                  </div>
                </div>
                <svg className="w-5 h-5 text-gray-400 group-hover:text-green-600 transition-colors shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </button>
            </div>
      ...
      <TermsAndConditions
        ...
        onAcceptRead={() => {}} // No necesitamos acción aquí, solo visualización
      />
