...
export const NotFoundPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0B0B0C] via-[#121317] to-[#1A1C22] flex items-center justify-center p-4">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              onClick={() => navigate('/')}
              className="py-3 px-6 bg-[#D4AF37] text-black font-semibold rounded-xl hover:bg-[#C9A227] transition-all shadow-lg"
            >
              🏠 Go to Home
            </button>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <button
                ...
                className="text-[#D4AF37] hover:text-[#C9A227] font-medium text-sm underline"
              >
                Dashboard
              </button>
              <button
